...
`)+`
`+O;let L=V+q+Y,A=V+O+X,T=ZH(Q,Q.VERTEX_SHADER,L),I=ZH(Q,Q.FRAGMENT_SHADER,A);if(Q.attachShader(D,T),Q.attachShader(D,I),Z.index0AttributeName!==void 0)Q.bindAttribLocation(D,0,Z.index0AttributeName);else if(Z.morphTargets===!0)Q.bindAttribLocation(D,0,"position");Q.linkProgram(D);function P(S){if(J.debug.checkShaderErrors){let h=Q.getProgramInfoLog(D).trim(),u=Q.getShaderInfoLog(T).trim(),l=Q.getShaderInfoLog(I).trim(),o=!0,d=!0;if(Q.getProgramParameter(D,Q.LINK_STATUS)===!1)if(o=!1,typeof J.debug.onShaderError==="function")J.debug.onShaderError(Q,D,T,I);else{let t=QH(Q,T,"vertex"),m=QH(Q,I,"fragment");console.error("THREE.WebGLProgram: Shader Error "+Q.getError()+" - VALIDATE_STATUS "+Q.getProgramParameter(D,Q.VALIDATE_STATUS)+`
